...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_book` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
(1,'c++ primer plus','未知','男',25,1,''),
(2,'钢筋混凝土教学','未知','男',35,2,''),
(3,'Java编程思想','埃克尔','男',28.8,1,'');
